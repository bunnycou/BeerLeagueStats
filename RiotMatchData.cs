...
namespace RiotMatchData
{
    // generated by https://json2csharp.com/
    // RiotMatchData myDeserializedClass = JsonConvert.DeserializeObject<RiotMatchData>(myJsonResponse);
    // Participant myDesearializedClass = JsonConvert.DeserializeObject<Participant>(myJsonResponse);
    public class Ban
    {
